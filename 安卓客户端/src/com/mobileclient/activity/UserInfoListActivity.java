				...
				handler.post(new Runnable() {
					...
					public void run() {
						...
						adapter = new UserInfoSimpleAdapter(UserInfoListActivity.this, list,
	        					...
	        					new String[] { "user_name","name","sex","birthday","telephone","photo" },
	        					new int[] { R.id.tv_user_name,R.id.tv_name,R.id.tv_sex,R.id.tv_birthday,R.id.tv_telephone,R.id.iv_photo,},lv);
	...
	private List<Map<String, Object>> getDatas() {
		...
		try {
			...
			for (int i = 0; i < userInfoList.size(); i++) {
				...
				map.put("photo", HttpUtil.BASE_URL+ userInfoList.get(i).getPhoto());
				list.add(map);
			}
		} catch (Exception e) { 
