...
public class NewsCollectionQueryActivity extends Activity {
	// 声明查询按钮
	...
	/*查询过滤条件保存到这个对象中*/
	private NewsCollection queryConditionNewsCollection = new NewsCollection();
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// 设置当前Activity界面布局
		setContentView(R.layout.newscollection_query);
		ImageView search = (ImageView) this.findViewById(R.id.search);
		search.setVisibility(View.GONE);
		TextView title = (TextView) this.findViewById(R.id.title);
		title.setText("设置新闻收藏查询条件");
		...
		spinner_newsObj.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> arg0, View arg1,int arg2, long arg3) {
				if(arg2 != 0)
					queryConditionNewsCollection.setNewsObj(newsList.get(arg2-1).getNewsId()); 
				else
					queryConditionNewsCollection.setNewsObj(0);
			}
			@Override
		...
		spinner_userObj.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> arg0, View arg1,int arg2, long arg3) {
				if(arg2 != 0)
					queryConditionNewsCollection.setUserObj(userInfoList.get(arg2-1).getUser_name()); 
				else
					queryConditionNewsCollection.setUserObj("");
			}
			@Override
			public void onNothingSelected(AdapterView<?> arg0) {}
		});
		...
		btnQuery.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				try {
					...
					//传输的内容仍然是键值对的形式
					bundle.putSerializable("queryConditionNewsCollection", queryConditionNewsCollection);
