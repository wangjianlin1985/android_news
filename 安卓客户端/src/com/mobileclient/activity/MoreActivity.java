...
public class MoreActivity extends Activity {
	private String[] strs = new String[]{"新闻标记","新闻评论","新闻收藏","新闻赞","图片分享","图片评论","视频分享","活动信息","修改个人信息","关于"};
		...
		list.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				// TODO Auto-generated method stub
								if(arg2 == 0){
					Intent intent  = new Intent(MoreActivity.this, NewsTagListActivity.class);
					startActivity(intent);
				}
				if(arg2 == 1){
					Intent intent  = new Intent(MoreActivity.this, NewsCommentListActivity.class);
					startActivity(intent);
				}
				if(arg2 == 2){
					Intent intent  = new Intent(MoreActivity.this, NewsCollectionListActivity.class);
					startActivity(intent);
				}
				if(arg2 == 3){
					Intent intent  = new Intent(MoreActivity.this, ZambiaListActivity.class);
					startActivity(intent);
				}
				if(arg2 == 4){
					Intent intent  = new Intent(MoreActivity.this, PhotoShareListActivity.class);
					startActivity(intent);
				}
				if(arg2 == 5){
					Intent intent  = new Intent(MoreActivity.this, PhotoCommentListActivity.class);
					startActivity(intent);
				}
				if(arg2 == 6){
					Intent intent  = new Intent(MoreActivity.this, VideoShareListActivity.class);
					startActivity(intent);
				}
				if(arg2 == 7){
