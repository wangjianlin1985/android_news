				...
				handler.post(new Runnable() {
					...
					public void run() {
						...
						adapter = new NewsSimpleAdapter(NewsListActivity.this, list,
	        					...
	        					new String[] { "newsId","newsClassObj","newsTitle","newsPhoto","comFrom","hitNum","addTime" },
	        					new int[] { R.id.tv_newsId,R.id.tv_newsClassObj,R.id.tv_newsTitle,R.id.iv_newsPhoto,R.id.tv_comFrom,R.id.tv_hitNum,R.id.tv_addTime,},lv);
	...
	private List<Map<String, Object>> getDatas() {
		...
		try {
			...
			for (int i = 0; i < newsList.size(); i++) {
				...
				map.put("comFrom", newsList.get(i).getComFrom());
				map.put("hitNum", newsList.get(i).getHitNum());
				map.put("addTime", newsList.get(i).getAddTime());
				list.add(map);
			}
		} catch (Exception e) { 
