			...
			public void onClick(View v) {
				try {
					...
					if(ET_comFrom.getText().toString().equals("")) {
						Toast.makeText(NewsAddActivity.this, "新闻来源输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_hitNum.getText().toString().equals("")) {
						Toast.makeText(NewsAddActivity.this, "浏览次数输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_addTime.getText().toString().equals("")) {
						Toast.makeText(NewsAddActivity.this, "添加时间输入不能为空!", Toast.LENGTH_LONG).show();
