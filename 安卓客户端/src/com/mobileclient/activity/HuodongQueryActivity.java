	...
	public void onCreate(Bundle savedInstanceState) {
		...
		spinner_userObj.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> arg0, View arg1,int arg2, long arg3) {
				if(arg2 != 0)
					queryConditionHuodong.setUserObj(userInfoList.get(arg2-1).getUser_name()); 
				else
					queryConditionHuodong.setUserObj("");
			}
			@Override
		...
		btnQuery.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				try {
					/*获取查询参数*/
					queryConditionHuodong.setTitle(ET_title.getText().toString());
					queryConditionHuodong.setTelephone(ET_telephone.getText().toString());
					queryConditionHuodong.setAddTime(ET_addTime.getText().toString());
