...
public class ZambiaQueryActivity extends Activity {
	// 声明查询按钮
	...
	/*查询过滤条件保存到这个对象中*/
	private Zambia queryConditionZambia = new Zambia();
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// 设置当前Activity界面布局
		setContentView(R.layout.zambia_query);
		ImageView search = (ImageView) this.findViewById(R.id.search);
		search.setVisibility(View.GONE);
		TextView title = (TextView) this.findViewById(R.id.title);
		title.setText("设置新闻赞查询条件");
		...
		spinner_newsObj.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> arg0, View arg1,int arg2, long arg3) {
				if(arg2 != 0)
					queryConditionZambia.setNewsObj(newsList.get(arg2-1).getNewsId()); 
				else
					queryConditionZambia.setNewsObj(0);
			}
			@Override
		...
		spinner_userObj.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> arg0, View arg1,int arg2, long arg3) {
				if(arg2 != 0)
					queryConditionZambia.setUserObj(userInfoList.get(arg2-1).getUser_name()); 
				else
					queryConditionZambia.setUserObj("");
			}
			@Override
			public void onNothingSelected(AdapterView<?> arg0) {}
		});
		...
		btnQuery.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				try {
					...
					//传输的内容仍然是键值对的形式
					bundle.putSerializable("queryConditionZambia", queryConditionZambia);
