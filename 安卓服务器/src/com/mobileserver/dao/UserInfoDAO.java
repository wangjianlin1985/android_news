...
public class UserInfoDAO {
	...
	public List<UserInfo> QueryUserInfo(String user_name,String name,Timestamp birthday,String telephone) {
		...
		try {
			...
			while (rs.next()) {
				...
				userInfo.setMemo(rs.getString("memo"));
	...
	public String AddUserInfo(UserInfo userInfo) {
		...
		try {
			/* 构建sql执行插入新用户信息 */
			String sqlString = "insert into UserInfo(user_name,password,name,sex,birthday,telephone,email,address,photo,memo) values (";
