...
public class NewsCommentAction extends BaseAction {
    ...
    public String AddNewsComment() {
        ...
        try {
            ...
            ctx.put("message",  java.net.URLEncoder.encode("NewsComment添加成功!"));
            return "add_success";
            ...
            e.printStackTrace();
            ctx.put("error",  java.net.URLEncoder.encode("NewsComment添加失败!"));
            return "error";
        }
    }
...
newsComment.getContent(),newsComment.getCommentTime()});
    ...
    public String ModifyNewsComment() {
        ...
        try {
            ...
            ctx.put("message",  java.net.URLEncoder.encode("NewsComment信息更新成功!"));
            return "modify_success";
        } catch (Exception e) {
            e.printStackTrace();
            ctx.put("error",  java.net.URLEncoder.encode("NewsComment信息更新失败!"));
            return "error";
       }
   }
    ...
    public String DeleteNewsComment() {
        ...
        try { 
            ...
            ctx.put("message",  java.net.URLEncoder.encode("NewsComment删除成功!"));
            return "delete_success";
        } catch (Exception e) { 
            e.printStackTrace();
            ctx.put("error",  java.net.URLEncoder.encode("NewsComment删除失败!"));
            return "error";
        }
    }
