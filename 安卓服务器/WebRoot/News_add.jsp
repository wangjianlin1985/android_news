...
<table width='100%' cellspacing='1' cellpadding='3' class="tablewidth">
  ...
  <tr>
    <td width=30%>新闻来源:</td>
    <td width=70%><input id="news.comFrom" name="news.comFrom" type="text" size="20" /></td>
  </tr>

  <tr>
    <td width=30%>浏览次数:</td>
    <td width=70%><input id="news.hitNum" name="news.hitNum" type="text" size="8" /></td>
  </tr>

  <tr>
    <td width=30%>添加时间:</td>
    <td width=70%><input id="news.addTime" name="news.addTime" type="text" size="20" /></td>
  </tr>
