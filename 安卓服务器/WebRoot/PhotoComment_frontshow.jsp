...
<table width='100%' cellspacing='1' cellpadding='3'  class="tablewidth">
  <tr>
    <td width=30%>评论id:</td>
    <td width=70%><%=photoComment.getPhotoCommentId() %></td>
  </tr>

  <tr>
    <td width=30%>被评图片:</td>
    <td width=70%>
      <%=photoComment.getPhotoObj().getPhotoTitle() %>
    </td>
  </tr>

  <tr>
    <td width=30%>评论内容:</td>
    <td width=70%><%=photoComment.getContent() %></td>
  </tr>

  <tr>
    <td width=30%>用户:</td>
    <td width=70%>
      <%=photoComment.getUserInfoObj().getName() %>
    </td>
  </tr>

  <tr>
    <td width=30%>评论时间:</td>
    <td width=70%><%=photoComment.getCommentTime() %></td>
  </tr>
