...
<table width='100%' cellspacing='1' cellpadding='3'  class="tablewidth">
  <tr>
    <td width=30%>收藏id:</td>
    <td width=70%><%=newsCollection.getCollectionId() %></td>
  </tr>

  <tr>
    <td width=30%>被收藏新闻:</td>
    <td width=70%>
      <%=newsCollection.getNewsObj().getNewsTitle() %>
    </td>
  </tr>
  ...
  <tr>
    <td width=30%>收藏时间:</td>
    <td width=70%><%=newsCollection.getCollectTime() %></td>
  </tr>
