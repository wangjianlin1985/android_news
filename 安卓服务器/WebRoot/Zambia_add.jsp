...
<TABLE align="center" height="100%" cellSpacing=0 cellPadding=0 width="80%" border=0>
  ...
  <TR>
    ...
    <s:form action="Zambia/Zambia_AddZambia.action" method="post" id="zambiaAddForm" onsubmit="return checkForm();"  enctype="multipart/form-data" name="form1">
<table width='100%' cellspacing='1' cellpadding='3' class="tablewidth">
  ...
  <tr>
    <td width=30%>被赞时间:</td>
    <td width=70%><input id="zambia.zambiaTime" name="zambia.zambiaTime" type="text" size="20" /></td>
  </tr>
